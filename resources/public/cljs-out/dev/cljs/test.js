...
var G__11372 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11372,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11372;
}
});
...
var len__4730__auto___11377 = arguments.length;
var i__4731__auto___11378 = (0);
while(true){
if((i__4731__auto___11378 < len__4730__auto___11377)){
args__4736__auto__.push((arguments[i__4731__auto___11378]));

var G__11379 = (i__4731__auto___11378 + (1));
i__4731__auto___11378 = G__11379;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11374){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11375,G__11376,seq11374__$2);
});
...
var map__11381 = m;
var map__11381__$1 = (((((!((map__11381 == null))))?(((((map__11381.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11381.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11381):map__11381);
var file = cljs.core.get.call(null,map__11381__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11381__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11381__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__11381,map__11381__$1,file,line,column){
return (function (p1__11380_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11380_SHARP_));
});})(map__11381,map__11381__$1,file,line,column))
...
var temp__5457__auto___11383 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___11383)){
var message_11384 = temp__5457__auto___11383;
cljs.core.println.call(null,message_11384);
} else {
}
...
var temp__5457__auto___11385 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___11385)){
var message_11386 = temp__5457__auto___11385;
cljs.core.println.call(null,message_11386);
} else {
}
...
var output_dir__$1 = (function (){var G__11387 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11387,"/"].join('');
} else {
return G__11387;
}
})();
...
var G__11389 = exception.stack;
var G__11389__$1 = (((G__11389 == null))?null:clojure.string.split_lines.call(null,G__11389));
var G__11389__$2 = (((G__11389__$1 == null))?null:cljs.core.get.call(null,G__11389__$1,depth));
if((G__11389__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11389__$2);
}
} else {
...
var vec__11390 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11390,(0),null);
var column = cljs.core.nth.call(null,vec__11390,(1),null);
var vec__11393 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11393,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11393,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11393,(2),null);
...
var m__$1 = (function (){var G__11396 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11400 = (function (){var G__11399 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11399);
} else {
return G__11399;
}
})();
...
return cljs.core.vary_meta.call(null,G__11401,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11405 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11405,(0),null);
var types = vec__11405;
...
return cljs.core.map.call(null,(function (p__11408){
var vec__11409 = p__11408;
var ns = cljs.core.nth.call(null,vec__11409,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11409,(1),null);
return ((function (vec__11409,ns,vars__$1){
return (function (){
...
var G__11412 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11412__$1 = (((G__11412 instanceof cljs.core.Keyword))?G__11412.fqn:null);
switch (G__11412__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__11412,G__11412__$1,env,once_fixtures,each_fixtures,vec__11409,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__11412,G__11412__$1,env,once_fixtures,each_fixtures,vec__11409,ns,vars__$1){
return (function (){
var seq__11413 = cljs.core.seq.call(null,vars__$1);
var chunk__11414 = null;
var count__11415 = (0);
var i__11416 = (0);
while(true){
if((i__11416 < count__11415)){
var v = cljs.core._nth.call(null,chunk__11414,i__11416);
var temp__5457__auto___11418 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___11418)){
var t_11419 = temp__5457__auto___11418;
each_fixture_fn.call(null,((function (seq__11413,chunk__11414,count__11415,i__11416,t_11419,temp__5457__auto___11418,v,each_fixture_fn,G__11412,G__11412__$1,env,once_fixtures,each_fixtures,vec__11409,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11419)));
});})(seq__11413,chunk__11414,count__11415,i__11416,t_11419,temp__5457__auto___11418,v,each_fixture_fn,G__11412,G__11412__$1,env,once_fixtures,each_fixtures,vec__11409,ns,vars__$1))
);
} else {
}


var G__11420 = seq__11413;
var G__11421 = chunk__11414;
var G__11422 = count__11415;
var G__11423 = (i__11416 + (1));
seq__11413 = G__11420;
chunk__11414 = G__11421;
count__11415 = G__11422;
i__11416 = G__11423;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__11413);
if(temp__5457__auto__){
var seq__11413__$1 = temp__5457__auto__;
...
var G__11424 = cljs.core.chunk_rest.call(null,seq__11413__$1);
var G__11425 = c__4550__auto__;
var G__11426 = cljs.core.count.call(null,c__4550__auto__);
var G__11427 = (0);
seq__11413 = G__11424;
chunk__11414 = G__11425;
count__11415 = G__11426;
i__11416 = G__11427;
continue;
} else {
var v = cljs.core.first.call(null,seq__11413__$1);
var temp__5457__auto___11428__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___11428__$1)){
var t_11429 = temp__5457__auto___11428__$1;
each_fixture_fn.call(null,((function (seq__11413,chunk__11414,count__11415,i__11416,t_11429,temp__5457__auto___11428__$1,v,seq__11413__$1,temp__5457__auto__,each_fixture_fn,G__11412,G__11412__$1,env,once_fixtures,each_fixtures,vec__11409,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11429)));
});})(seq__11413,chunk__11414,count__11415,i__11416,t_11429,temp__5457__auto___11428__$1,v,seq__11413__$1,temp__5457__auto__,each_fixture_fn,G__11412,G__11412__$1,env,once_fixtures,each_fixtures,vec__11409,ns,vars__$1))
);
} else {
}


var G__11430 = cljs.core.next.call(null,seq__11413__$1);
var G__11431 = null;
var G__11432 = (0);
var G__11433 = (0);
seq__11413 = G__11430;
chunk__11414 = G__11431;
count__11415 = G__11432;
i__11416 = G__11433;
continue;
}
} else {
...
});})(each_fixture_fn,G__11412,G__11412__$1,env,once_fixtures,each_fixtures,vec__11409,ns,vars__$1))
);
});})(each_fixture_fn,G__11412,G__11412__$1,env,once_fixtures,each_fixtures,vec__11409,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11412__$1)].join('')));

}
})());
});
;})(vec__11409,ns,vars__$1))
