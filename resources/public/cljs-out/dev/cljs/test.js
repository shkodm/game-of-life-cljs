...
var G__10132 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10132,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10132;
}
});
...
var len__4730__auto___10137 = arguments.length;
var i__4731__auto___10138 = (0);
while(true){
if((i__4731__auto___10138 < len__4730__auto___10137)){
args__4736__auto__.push((arguments[i__4731__auto___10138]));

var G__10139 = (i__4731__auto___10138 + (1));
i__4731__auto___10138 = G__10139;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10134){
var G__10135 = cljs.core.first.call(null,seq10134);
var seq10134__$1 = cljs.core.next.call(null,seq10134);
var G__10136 = cljs.core.first.call(null,seq10134__$1);
var seq10134__$2 = cljs.core.next.call(null,seq10134__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10135,G__10136,seq10134__$2);
});
...
var file = cljs.core.get.call(null,map__10141__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10141__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10141__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10141,map__10141__$1,file,line,column){
return (function (p1__10140_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10140_SHARP_));
});})(map__10141,map__10141__$1,file,line,column))
...
var temp__5457__auto___10143 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10143)){
var message_10144 = temp__5457__auto___10143;
cljs.core.println.call(null,message_10144);
} else {
}
...
var temp__5457__auto___10145 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10145)){
var message_10146 = temp__5457__auto___10145;
cljs.core.println.call(null,message_10146);
} else {
}
...
var output_dir__$1 = (function (){var G__10147 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10147,"/"].join('');
} else {
return G__10147;
}
})();
...
var G__10149 = exception.stack;
var G__10149__$1 = (((G__10149 == null))?null:clojure.string.split_lines.call(null,G__10149));
var G__10149__$2 = (((G__10149__$1 == null))?null:cljs.core.get.call(null,G__10149__$1,depth));
if((G__10149__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10149__$2);
}
} else {
...
var vec__10150 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10150,(0),null);
var column = cljs.core.nth.call(null,vec__10150,(1),null);
var vec__10153 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10153,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10153,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10153,(2),null);
...
var m__$1 = (function (){var G__10156 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__10160 = (function (){var G__10159 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10159);
} else {
return G__10159;
}
})();
...
return cljs.core.vary_meta.call(null,G__10161,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e10162){var e = e10162;
var G__10163 = e;
var G__10163__$1 = (((G__10163 instanceof cljs.core.Keyword))?G__10163.fqn:null);
switch (G__10163__$1) {
...
var vec__10165 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10165,(0),null);
var types = vec__10165;
...
return cljs.core.map.call(null,(function (p__10168){
var vec__10169 = p__10168;
var ns = cljs.core.nth.call(null,vec__10169,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10169,(1),null);
return ((function (vec__10169,ns,vars__$1){
return (function (){
...
var G__10172 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10172,G__10172__$1,env,once_fixtures,each_fixtures,vec__10169,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10172,G__10172__$1,env,once_fixtures,each_fixtures,vec__10169,ns,vars__$1){
return (function (){
var seq__10173 = cljs.core.seq.call(null,vars__$1);
var chunk__10174 = null;
var count__10175 = (0);
var i__10176 = (0);
while(true){
if((i__10176 < count__10175)){
var v = cljs.core._nth.call(null,chunk__10174,i__10176);
var temp__5457__auto___10178 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10178)){
var t_10179 = temp__5457__auto___10178;
each_fixture_fn.call(null,((function (seq__10173,chunk__10174,count__10175,i__10176,t_10179,temp__5457__auto___10178,v,each_fixture_fn,G__10172,G__10172__$1,env,once_fixtures,each_fixtures,vec__10169,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10179)));
});})(seq__10173,chunk__10174,count__10175,i__10176,t_10179,temp__5457__auto___10178,v,each_fixture_fn,G__10172,G__10172__$1,env,once_fixtures,each_fixtures,vec__10169,ns,vars__$1))
);
} else {
}


var G__10180 = seq__10173;
var G__10181 = chunk__10174;
var G__10182 = count__10175;
var G__10183 = (i__10176 + (1));
seq__10173 = G__10180;
chunk__10174 = G__10181;
count__10175 = G__10182;
i__10176 = G__10183;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__10173);
if(temp__5457__auto__){
var seq__10173__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10173__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__10173__$1);
var G__10184 = cljs.core.chunk_rest.call(null,seq__10173__$1);
var G__10185 = c__4550__auto__;
var G__10186 = cljs.core.count.call(null,c__4550__auto__);
var G__10187 = (0);
seq__10173 = G__10184;
chunk__10174 = G__10185;
count__10175 = G__10186;
i__10176 = G__10187;
continue;
} else {
var v = cljs.core.first.call(null,seq__10173__$1);
var temp__5457__auto___10188__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10188__$1)){
var t_10189 = temp__5457__auto___10188__$1;
each_fixture_fn.call(null,((function (seq__10173,chunk__10174,count__10175,i__10176,t_10189,temp__5457__auto___10188__$1,v,seq__10173__$1,temp__5457__auto__,each_fixture_fn,G__10172,G__10172__$1,env,once_fixtures,each_fixtures,vec__10169,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10189)));
});})(seq__10173,chunk__10174,count__10175,i__10176,t_10189,temp__5457__auto___10188__$1,v,seq__10173__$1,temp__5457__auto__,each_fixture_fn,G__10172,G__10172__$1,env,once_fixtures,each_fixtures,vec__10169,ns,vars__$1))
);
} else {
}


var G__10190 = cljs.core.next.call(null,seq__10173__$1);
var G__10191 = null;
var G__10192 = (0);
var G__10193 = (0);
seq__10173 = G__10190;
chunk__10174 = G__10191;
count__10175 = G__10192;
i__10176 = G__10193;
continue;
}
} else {
...
});})(each_fixture_fn,G__10172,G__10172__$1,env,once_fixtures,each_fixtures,vec__10169,ns,vars__$1))
);
});})(each_fixture_fn,G__10172,G__10172__$1,env,once_fixtures,each_fixtures,vec__10169,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10172__$1)].join('')));

}
})());
});
;})(vec__10169,ns,vars__$1))
