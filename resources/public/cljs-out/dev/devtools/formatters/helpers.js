...
var G__13113 = devtools.prefs.pref.call(null,v);
v = G__13113;
continue;
} else {
return v;
...
}catch (e13116){var _e__11926__auto__ = e13116;
return false;
}})();
...
}catch (e13120){var _e__11926__auto__ = e13120;
return false;
}})();
...
}catch (e13122){var _e__11926__auto__ = e13122;
return false;
}}
}
});
...
var vec__13124 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13124,(0),null);
var name = cljs.core.nth.call(null,vec__13124,(1),null);
...
return cljs.core.some.call(null,(function (p1__13127_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13127_SHARP_);
}),template);
});
